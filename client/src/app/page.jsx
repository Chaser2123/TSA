...
export default function Home() {
  return (
    <>
      ...
      <div className="relative flex items-center justify-center w-full h-150 border-y-8" style={{ backgroundImage: 'url("homepage.jpg")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <h1 className="absolute text-3xl w-300 h-100 flex items-center justify-center px-20 py-12 font-semibold text-center italic text-black border-black rounded-3xl border-2" style={{ backgroundColor: 'rgba(255, 255, 255, 0.3)' }}>
      ...
      <ImageCaurosel images = {['image-caurosel-photos/2.jpg', 'image-caurosel-photos/1.jpg', 'image-caurosel-photos/3.jpg']} />
    </>
  );
}
